...
namespace Fitness.Controllers
{
    ...
    public class SalonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Adres,CalismaSaatleri")] Salon salon)
        {
            if (ModelState.IsValid)
            {
                _context.Add(salon);
                await _context.SaveChangesAsync();
                TempData["Success"] = "Salon basariyla eklendi!";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Adres,CalismaSaatleri")] Salon salon)
        {
            if (id != salon.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["Success"] = "Salon basariyla guncellendi!";
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (salon != null)
            {
                ...
                await _context.SaveChangesAsync();
                TempData["Success"] = "Salon basariyla silindi!";
            }
